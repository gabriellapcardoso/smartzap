...
const statusBadgeVariants = cva(
  ...
  ].join(" "),
  {
    variants: {
      status: {
        // Generic status
        success: "bg-lime-500/10 text-[var(--ds-status-success-text)]",
        ...
        completed: "bg-lime-500/10 text-[var(--ds-status-success-text)]",
      ...
      {showDot && (
        <span
          className={cn(
            ...
            {
              "bg-lime-400": status === "success" || status === "completed",
