            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Container variant="default" padding="md" className="flex items-center justify-between">
                    ...
                    <div className="h-10 w-10 rounded-full bg-zinc-950/40 border border-white/10 flex items-center justify-center">
                        <Clock className={`w-5 h-5 ${hourlyCount >= 80 ? 'text-amber-300' : 'text-lime-300'}`} />
                    </div>
                </Container>
            </div>
                                    ...
                                    >
                                        <td className="px-6 py-4 max-w-[300px]">
                                            <div className="flex items-center gap-3">
                                                <div className="min-w-0">
                                                    <h3 className="font-medium text-white group-hover:text-lime-200 transition-colors truncate max-w-[280px]" title={submission.name}>
                                                        {submission.name}
                                                    </h3>
                                        ...
                                        <td className="px-6 py-4 w-48">
                                            <div className="h-2 w-full bg-zinc-950/60 rounded-full overflow-hidden flex">
                                                <div style={{ width: `${utilityPercent}%` }} className="bg-lime-500 transition-all duration-500" />
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            {submission.stats.utility > 0 ? (
                                                <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-medium bg-lime-500/10 text-lime-300 border border-lime-500/20">
